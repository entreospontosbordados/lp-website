      ...
      <div className="text-center max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          <div className="bg-card border rounded-lg p-6">
            <h3 className="font-means-web-medium text-xl text-primary mb-3">Design Thinking</h3>
            <p className="font-bevellier text-base text-muted-foreground mb-3">
              Metodologia centrada no usuário para inovação
            </p>
            <p className="font-means-web-light text-muted-foreground leading-relaxed text-sm">
          ...
          <div className="bg-card border rounded-lg p-6">
            <h3 className="font-means-web-medium text-xl text-card-foreground mb-3">UX Strategy</h3>
            <p className="font-bevellier text-base text-muted-foreground mb-3">
