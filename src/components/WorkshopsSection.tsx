export default function WorkshopsSection() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-green-200 to-brand-beige-200">
      <div className="text-center max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 border border-brand-orange-200">
            <h3 className="font-means-web-medium text-xl text-brand-orange-700 mb-3">Design Thinking</h3>
            <p className="font-bevellier text-base text-brand-green-700 mb-3">
              Metodologia centrada no usuário para inovação
            </p>
            <p className="font-means-web-light text-brand-green-600 leading-relaxed text-sm">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-6 border border-brand-green-200">
            <h3 className="font-means-web-medium text-xl text-brand-green-800 mb-3">UX Strategy</h3>
            <p className="font-bevellier text-base text-brand-green-700 mb-3">
