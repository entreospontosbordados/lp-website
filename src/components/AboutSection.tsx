export default function AboutSection() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-brand-green-100 to-brand-green-200">
      <div className="text-center max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 text-left">
          <div>
            <p className="font-means-web-light text-lg text-brand-green-600 leading-relaxed mb-4">
          ...
          <div>
            <p className="font-means-web-light text-lg text-brand-green-600 leading-relaxed">
