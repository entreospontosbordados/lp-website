export default function ProductsSection() {
  return (
    <section className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-50 to-amber-100">
      <div className="text-center max-w-5xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6">
            <h3 className="font-means-web-medium text-2xl text-gray-800 mb-4">Design System</h3>
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6">
            <h3 className="font-means-web-medium text-2xl text-gray-800 mb-4">Plataformas Web</h3>
            <p className="font-means-web-light text-gray-600 leading-relaxed">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-lg p-6">
            <h3 className="font-means-web-medium text-2xl text-gray-800 mb-4">Consultoria Digital</h3>
            <p className="font-means-web-light text-gray-600 leading-relaxed">
